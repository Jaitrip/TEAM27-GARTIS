 ...
 * @author jaimik
 */
public class SecondLatePaymentLetter {

    public SecondLatePaymentLetter() {
    }
    
    public void saveSecondLetter(String invoiceNumber, Connection connection) throws SQLException {
        ...
        try {
            ...
            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("SecondLatePaymentLetter" + invoiceNumber + ".pdf"));
            document.open();
            ...
            document.add(new Paragraph("SECOND REMINDER - INVOICE NO: " + invoiceNumber));
            ...
            document.add(new Paragraph("According to our records, it appears that we have not yet received payment of the above invoice, for work done, despite a reminder letter posted to you 1 month ago."));
            
            document.add(Chunk.NEWLINE);
            
            document.add(new Paragraph("We would appreciate it if you would settle this invoice in full by return."));
